...
class ConsolidatedDynamicATMAnalysis:
    ...
    def run_dynamic_analysis(self, expiry_week: str, day_label: str):
        ...
        if expiry_week.endswith('_DYNAMIC') or expiry_week.endswith('_STATIC'):
            resolved_base = base_dir / data_dir_name / expiry_week
        else:
            preferred_dynamic_base = base_dir / data_dir_name / f"{expiry_week}_DYNAMIC"
            legacy_dynamic_base = base_dir / data_dir_name / f"{expiry_week}_OTM"
            static_base = base_dir / data_dir_name / expiry_week

...
class StaticAnalysis:
    ...
    def _process_trades_for_entry_type(self, expiry_week: str, day_label: str, strike_types: list, entry_type: str):
        ...
        data_dir_name = self.config.get('PATHS', {}).get('DATA_DIR', 'data_st50') if self.config else 'data_st50'
        static_dir = self.base_dir / data_dir_name / f"{expiry_week}_STATIC/{day_label}"
            ...
            for strategy_file in strategy_files:
                ...
                try:
                    ...
                    for _, entry_row in entry_signals.iterrows():
                        ...
                        # Example: Conditions true at end of 12:52 (completes at 12:52:00) -> Entry at 12:53:01
                        ...
                        # - Backtesting lowest resolution is 1 minute (e.g., "12:52:00") because it uses minute candles

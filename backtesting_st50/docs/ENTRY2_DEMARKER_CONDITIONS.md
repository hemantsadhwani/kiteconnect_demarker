...
References: `backtesting_st50/strategy.py` (`_check_entry2_signal_demarker`, main loop), `backtesting_st50/backtesting_config.yaml`, `backtesting_st50/indicators_config.yaml`.

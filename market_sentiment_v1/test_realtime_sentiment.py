"""
Test script for Real-Time Market Sentiment Manager (v1)
CPR + Type 2 bands, NCP state machine. Matches backtesting cpr_market_sentiment_v1 behavior.
    ...
    async def process_todays_candles(self):
        ...
        try:
            ...
            for candle_data in data_sorted:
                ...
                # NCP = same as backtest (grid_search cpr_market_sentiment_v1): Bullish (C>=O) -> (H+C)/2, Bearish -> (L+C)/2
